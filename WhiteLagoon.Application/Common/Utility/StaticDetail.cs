...
namespace WhiteLagoon.Application.Common.Utility
{
    public static class StaticDetail
    {
            ...
            List<Booking> bookings)
        {
            ...
            int finalAvailableRoomForAllNigts = int.MaxValue;
            ...
            for (int i = 0; i < nights; i++)
            {
                ...
                {
                    if (finalAvailableRoomForAllNigts > totalAvailableRooms)
                    {
                        finalAvailableRoomForAllNigts = totalAvailableRooms;
                    }
                }
            }
            return finalAvailableRoomForAllNigts;
        }
    }
}